...
function FrontPage() {
    ...
    <MenuBar />
    <Carousel />
    <TextField header="Witaj na FitCrafters - Miejscu, gdzie Kształtujesz Siłę!"
    ...
    <QuoteCard quote="Dzisiaj zrobię to, czego inni nie zrobią, więc jutro mogę osiągnąć to, czego inni nie mogą." author="Jerry Rice"/>
    <TextField header="Nasza misja"
